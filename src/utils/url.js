...
export const catagoriesUrl = `https://youtube.googleapis.com/youtube/v3/videoCategories?part=snippet&regionCode=US&key=${Google_Api_Key}`
export const Videos_By_Catagory_Id_Url = `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&videoCategoryId=10&key=${Google_Api_Key}`